...
import { CATEGORIES, RECIPES, getGuideContent, getHabitContent } from './KubectlTool.data.jsx';

export default function KubectlTool() {
    const [activeCat, setActiveCat] = useState('config');
    const [activeRecipeId, setActiveRecipeId] = useState('view-config');
        ...
        <ToolLayout>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(200px, 240px) 1fr', gap: 12, flex: 1, minHeight: 0 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 12, minHeight: 0 }}>
                    ...
                    <Panel title="Kubectl Guide & Pro Tips">
