      ...
      },
      {
        ...
        fields: [
          ...
          { id: 'source', label: 'Branch to merge', placeholder: 'feature/my-feature' },
          {
            ...
            label: 'Strategy',
            type: 'select',
            options: ['--no-ff', '--ff-only', '--squash', '(default)'],
          },
        ],
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        fields: [
          { id: 'msg', label: 'New message (blank = keep)', placeholder: 'fix: correct typo' },
        ],
        build: ({ msg }) =>
          msg ? `git commit --amend -m "${msg}"` : 'git commit --amend --no-edit',
      },
      {
        id: 'revert',
        label: 'Revert commit',
    ...
    items: [
      {
        ...
        build: ({ remote, branch }) =>
          `git pull --rebase ${remote || 'origin'} ${branch || 'main'}`,
      },
      {
        id: 'push',
        label: 'Push branch',
        ...
        fields: [
          ...
          { id: 'branch', label: 'Branch', placeholder: 'feature/my-feature' },
          {
            ...
            label: 'Force push?',
            type: 'select',
            options: ['No', 'Yes (--force-with-lease)', 'Yes (--force)'],
          },
        ],
        ...
        fields: [
          {
            ...
            label: 'Action',
            type: 'select',
            options: ['stash', 'stash pop', 'stash list', 'stash drop'],
          },
